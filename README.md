...
**TL;DR:** We propose a route planning system that uses an LLM-as-Parser to interpret natural language and extract user preferences, and employs a multi-step graph search to trade off human objectives under multiple constraints.
